// Calendar
function checkEarlierDay(date, year, month, day) {
...
function checkEarlierMonth(date,year,month)
{
    if (year < date.getFullYear()) {
        return true;
    }
    else return !!(year == date.getFullYear() && month < date.getMonth());
}
function checkEarlierYear(date,year)
{
...
(function ($) {
    $.widget("metro.calendar", {
        ...
        _create: function () {
            ...
            if (element.data('minDate') != undefined) this.options.minDate = new Date(element.data("minDate"));
        ...
        _renderMonth: function () {
            ...
            $("<td/>").addClass("text-center").html("<a class='btn-previous-year' href='#'><i class='fa fa-angle-double-left'></i></a>").appendTo(tr);
            $("<td/>").addClass("text-center").html("<a class='btn-previous-month' href='#'><i class='fa fa-angle-left'></i></a>").appendTo(tr);
            ...
            $("<td/>").addClass("text-center").html("<a class='btn-next-month' href='#'><i class='fa fa-angle-right'></i></a>").appendTo(tr);
            $("<td/>").addClass("text-center").html("<a class='btn-next-year' href='#'><i class='fa fa-angle-double-right'></i></a>").appendTo(tr);
            ...
            for (i = 1; i <= daysInMonth; i++) {
                ...
                td = checkEarlierDay(this.options.minDate, year, month, i) ?
                    $("<td/>").addClass("text-center day").html("<div class='other-day'>" + i + "</div>") :
                    $("<td/>").addClass("text-center day").html("<a href='#'>" + i + "</a>");
        ...
        _renderMonths: function () {
            ...
            for (i = 0; i < 12; i++) {
                ...
                td = checkEarlierMonth(this.options.minDate, this._year, i) ?
                    $("<td/>").addClass("text-center month").html("<div class='other-monthYear' data-month='" + i + "'>" + $.Metro.Locale[this.options.locale].months[i + 12] + "</div>"):
                    $("<td/>").addClass("text-center month").html("<a href='#' data-month='" + i + "'>" + $.Metro.Locale[this.options.locale].months[i + 12] + "</a>");
        ...
        _renderYears: function () {
            ...
            for (i = this._distance; i < this._distance + 12; i++) {
                td = checkEarlierYear(this.options.minDate,i)?
                    $("<td/>").addClass("text-center year").html("<div class='other-monthYear' data-year='" + i + "'>" + i + "</div>"):
                    $("<td/>").addClass("text-center year").html("<a href='#' data-year='" + i + "'>" + i + "</a>");
