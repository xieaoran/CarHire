...
(function ($) {
    $.widget("metro.datepicker", {
        ...
        _create: function () {
            ...
            if (element.data('minDate') != undefined) this.options.minate = element.data('minDate');
        ...
        _createCalendar: function (to, curDate) {
            ...
            if (that.options.minDate != undefined) {
                _calendar.data('minDate', that.options.minDate);
            }

            if (this.options.isStartDate) {
                _calendar.calendar({
                    multiSelect: false,
